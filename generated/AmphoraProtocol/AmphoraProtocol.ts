...
export class AmphoraProtocol__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class AmphoraProtocol extends ethereum.SmartContract {
  static bind(address: Address): AmphoraProtocol {
    return new AmphoraProtocol("AmphoraProtocol", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): AmphoraProtocol__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<AmphoraProtocol__checkpointsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<AmphoraProtocol__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<AmphoraProtocol__checkpointsResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
